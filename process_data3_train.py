...
def main():
    ...
    wav_scp_path = "../SPAPL_KidsASR/egs/MyST/data/train_myst_nocomb/wav.scp"
    text_path = "../SPAPL_KidsASR/egs/MyST/data/train_myst_nocomb/text"
    output_dir = "data"
    ...
    processed_file = os.path.join(output_dir, "processed_files_train.json")
    filtered_stats_file = os.path.join(output_dir, "filtered_stats_train.json")
