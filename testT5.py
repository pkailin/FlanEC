...
model_path = "./t5-models/checkpoint-36150"  
...
with open("testT5-corr_sclite.txt", "w", encoding="utf-8") as results_file:
...
wer = jiwer.wer(actual_lst, pred_lst)
print("Overall WER: " + str(wer))


# Get Detailed Measures
measures = jiwer.compute_measures(actual_lst, pred_lst)
